    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/CelestialStag/stagcss/dist/stag.min.css" />
          <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/CelestialStag/stagcss/dist/stag-ext.min.css" />
        </Head>
        <body>
          <Main />
          <NextScript />
